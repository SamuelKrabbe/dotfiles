...
# -------------------------------------------------
# Git commit script for scripts with enforced tags
# -------------------------------------------------
...
show_help() {
    echo "Usage: update-scritps -m \"<tag>: <message>\""
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  update-scritps -m \"feat: add new Alacritty theme\""
    echo "  update-scritps          # will prompt for message interactively"
}

...
if systemctl is-enabled deepcool-digital-linux.service &>/dev/null; then
    echo "DeepCool service already enabled, skipping."
else
    echo "Installing DeepCool AG400 Digital..."
    ./deepcool-setup.sh
fi
